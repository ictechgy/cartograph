...
```bash
mint install ictechgy/cartograph@0.8.0
```
...
```swift
// Package.swift
.package(url: "https://github.com/ictechgy/cartograph", revision: "0.8.0"),
```
...
$ cartograph bridges
{
  ...
  "project" : "/app/ios",
  "target" : "flutter",
  "tool" : { "name" : "cartograph", "version" : "0.8.0" },
  "version" : 1
}
```
...
a finding list, so the lens has nothing to attach to.
