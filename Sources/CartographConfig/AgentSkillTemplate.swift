...
public enum AgentSkillTemplate {
    ...
    public static let markdown = """
        ---
        name: cartograph
        description: Use before deleting or editing Swift declarations, for change impact and runtime \
        dependency preflight, when cleaning dead or unused code, and when asked who calls or depends \
        on a declaration. Supports efficient MCP queries and CI checks.
        ---
